  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className='flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4'>
        ...
        <div className='flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden gap-1'>
          <span className='text-xl line-clamp-2 text-white'>
            {video?.title}
          </span>
          <div className='flex text-sm text-white/[0.7] truncate overflow-hidden'>
